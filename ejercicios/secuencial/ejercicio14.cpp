//################################################################################
//Dado un número de dos cifras, hacer un algoritmo que permita obtener el 
//número invertido. 
//################################################################################
//Análisis
...
//Información de salida: primera cifra, segunda cifra (Entero)
...
int main(int argc, char *argv[]) {
	...
	int num;
	int unidades;
	cout << "Dime un número de dos cifras: ";
	cin >> num;
	decenas = num / 10;
	unidades = num % 10;
