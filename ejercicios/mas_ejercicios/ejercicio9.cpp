//################################################################################
//Programar el juego "Mastermind", para ello el programa debe "eligir" un número 
//de cuatro cifras (sin cifras repetidas), que será el código que el jugador debe
//adivinar en la menor cantidad de intentos posibles. Cada intento consiste en una
//propuesta de un código que escribe el jugador, y una respuesta del programa. 
//Las respuestas le darán pistas al jugador para que pueda deducir el código:
// * número de "MUERTOS": cantidad de dígitos que están en el número secreto y en 
//   la misma posición,
// * número de "HERIDOS": cantidad de dígitos que están en el número secreto pero
